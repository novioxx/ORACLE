...
SELECT CNO,CNAME,P.PNO,P.PNAME

--2) 화학과 학생의 기말고사 성적을 모두 검색하라(JOIN USING 사용)
SELECT SNO, ST.SNAME, ST.MAJOR, SC.RESULT
FROM STUDENT
JOIN SCORE
USING (SNO)
WHERE ST.MAJOR ='화학'
...
SELECT C.CNO, C.CNAME, PNO, PNAME, SECTION 
FROM COURSE C
...
SELECT SNO,ST.SNAME,ST.MAJOR,ST.SYEAR,CNO,C.CNAME
FROM STUDENT ST
NATURAL JOIN SCORE SC
NATURAL JOIN COURSE C
WHERE ST.MAJOR ='화학'AND SYEAR = 1;